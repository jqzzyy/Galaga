...
module enemy #(
    ...
    // bullet render wires 3 px wide 8 px tall
    ...
    initial begin
        ...
        enemy_green[ 0] = 16'b0000000000000000;
        enemy_green[ 1] = 16'b0000000000000000;
        enemy_green[ 2] = 16'b0000000000000000;
        enemy_green[ 3] = 16'b0000000000000000;
        enemy_green[ 4] = 16'b0000000100000000;
        enemy_green[ 5] = 16'b0000010101000000; 
        enemy_green[ 6] = 16'b0000000100000000;
        enemy_green[ 7] = 16'b0000011111000000;
        enemy_green[ 8] = 16'b0000001110000000;
        enemy_green[ 9] = 16'b0000000000000000;
        enemy_green[10] = 16'b0000000000000000;
        enemy_green[11] = 16'b0000001110000000;
        enemy_green[12] = 16'b0000000000000000;
        enemy_green[13] = 16'b0000000000000000;
        enemy_green[14] = 16'b0000000000000000;
        enemy_green[15] = 16'b0000000000000000;
    ...
    always @(posedge frame) begin
        ...
        prng_load <= 0; // default is dont reload
        ...
        if (escanline_count < 524) begin
            ...
            if (ebullet) begin
                if (ebullet_y >= 480) begin
                    ...
                    ebullet_y <= ebullet_y + ebullet_speed;
    ...
    always @(*) begin
        ...
        if (in_ebullet_x && in_ebullet_y) begin
            R_out = 4'hF; G_out = 4'h4; B_out = 4'h0;
            active = 1;
        end else if (in_enemy_x && in_enemy_y) begin
            //if any bit is high in the bitmap, it turns on the color channel for that color
            R_out = enemy_red[sprite_row][15 - sprite_col]   ? 4'hF : 4'h0;
            G_out = enemy_green[sprite_row][15 - sprite_col] ? 4'hF : 4'h0;
            B_out = enemy_blue[sprite_row][15 - sprite_col]  ? 4'hF : 4'h0;
            // active goes high if any bit is set
            active = enemy_red[sprite_row][15 - sprite_col] || enemy_green[sprite_row][15 - sprite_col] || enemy_blue[sprite_row][15 - sprite_col];
        end else begin
