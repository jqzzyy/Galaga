namespace eval ::optrace {
  variable script "X:/EC311/Galaga Final Project/Galaga Final Project.runs/impl_1/top.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir {X:/EC311/Galaga Final Project/Galaga Final Project.cache/wt} [current_project]
  set_property parent.project_path {X:/EC311/Galaga Final Project/Galaga Final Project.xpr} [current_project]
  set_property ip_output_repo {{X:/EC311/Galaga Final Project/Galaga Final Project.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet {{X:/EC311/Galaga Final Project/Galaga Final Project.runs/synth_1/top.dcp}}
OPTRACE "read constraints: implementation" START { }
  read_xdc {{X:/EC311/Galaga Final Project/Galaga Final Project.srcs/constrs_1/imports/vga_demo/constraints.xdc}}
